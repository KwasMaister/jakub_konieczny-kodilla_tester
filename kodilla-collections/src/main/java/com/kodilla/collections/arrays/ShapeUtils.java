...
public class ShapeUtils {
    ...
    private static String getShapeName(Shape shape) {
        if (shape instanceof Circle)
            return "Circle";
        else if (shape instanceof Triangle)  //operator "instanceof" zwraca wartosc true lub false w zaleznosci od tego, czy dany obiekt jest w wskazanej klasie czy tez nie
            return "Triangle";
